...
const AdminLayout = ({ children, pageTitle, pageSubtitle }) => {
  ...
  const menuItems = [
    ...
    { path: '/dashboard-admin/categorias', label: 'Categorias', icon: 'categories' },
    { path: '/dashboard-admin/produtos', label: 'Produtos', icon: 'products' },
    { path: '/dashboard-admin/leiloes', label: 'Leilões', icon: 'auctions' },
    { path: '/dashboard-admin/lances', label: 'Lances', icon: 'bids' },
    { path: '/dashboard-admin/cashback', label: 'Cashback', icon: 'cashback' },
    { path: '/dashboard-admin/transacoes', label: 'Transações', icon: 'transactions' },
    { path: '/dashboard-admin/relatorios', label: 'Relatórios', icon: 'reports' },
    { path: '/dashboard-admin/configuracoes', label: 'Configurações', icon: 'settings' }
  ];
